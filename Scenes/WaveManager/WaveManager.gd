...
const ENEMY_WAVES = preload("uid://da88lfxnu7wh2")
...
func update_speeds() -> void:
	if ENEMY_WAVES.wave_is_start(_wave_count) == true:
		_speed_factor *= 1.02
		_wave_gap *= 0.97
...
func spawn_wave() -> void:
	...
	var wave: EnemyWave = ENEMY_WAVES.get_wave_for_wave_count(_wave_count)
